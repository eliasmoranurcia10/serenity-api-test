...
import org.nttdata.testing.questions.ResponseCode;
import org.nttdata.testing.tasks.GetAirlines;
import org.nttdata.testing.tasks.PostAirline;
...
public class AirlineStepDefinitions {
    ...
    @When("el {actor} envia un {string} en una solicitud GET")
    public void elActorEnviaUnIdEnUnaSolicitudGET(Actor actor, String _id) {
        actor.attemptsTo(GetAirlines.fromEndpoint("/airlines/" + _id));
    }
}
